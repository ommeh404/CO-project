...
def bin8(num):
    ...
    bin_num=bin_num1[::-1]
    return bin_num
with open("co proj/assembly code.txt",'r') as file:
...
def error_identification(instructions,instruct_list,labels,reserved,registers,register_list,type_A,type_B,type_C,type_D,type_E,type_F):
    error=0
    instruction_list=[]
